...
**Image Studio is the one exception**: it embeds the [libimagequant](https://github.com/ImageOptim/libimagequant) PNG engine, which is licensed **GPL-3.0-or-later**. See [image-studio/README.md](image-studio/README.md) for the full breakdown of bundled third-party components and licenses.
